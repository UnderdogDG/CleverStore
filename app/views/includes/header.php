...
<head>
  ...
  <title><?= SITE; ?></title>
  <link rel="shortcut icon" href="img/sitio/clever_icon.ico" type="image/x-icon">
  <link rel="icon" href="<?= URL; ?>/img/sitio/clever_icon.ico" type="image/x-icon">
  ...
  <link rel="stylesheet" type="text/css" href="<?= URL; ?>/public/css/main.min.css">
</head>
<body>