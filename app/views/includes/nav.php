<nav class="nav item hidden transition">
  <div class="wrapper">
    ...
    <div class="compress">
      ...
      <a class="icon" href="<?= (isset($_SESSION["user"]))? URL . '/user/perfil' : URL . '/user/nouser';?>">
      ...
      <a class="icon" href="<?= (isset($_SESSION["user"]))? URL . '/user/cart' : URL . '/user/nouser';?>">
        ...
        <div class="count">
          <input id="counter" type="text" value="<?= (isset($_SESSION["cart"]))? count($_SESSION["cart"]) : 0; ?>" disabled="disabled">
        </div>
        <h2>Carrito</h2>
      </a>
