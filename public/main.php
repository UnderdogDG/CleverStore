...
<body>
  <div id="fullpage">
    ...
    <nav class="nav">
      ...
      <div class="menu">
        <a href="#" class="menu_item">Ropa</a>
        <a href="#" class="menu_item">Joyería</a>
        <a href="#" class="menu_item">Zapatos</a>
        <a href="#" class="menu_item">Accesorios</a>
      </div>
    ...
    <main>
      <div class="section">
        ...
        <div class="container_main">
          ...
          <div class="container_main_pleca">
